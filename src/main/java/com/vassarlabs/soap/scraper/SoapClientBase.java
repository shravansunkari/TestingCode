...
public class SoapClientBase {
	public static void main(String args[]) {
		...
		try {
			...
			SOAPMessage soapResponse = soapConnection.call(createSOAPRequest("20913"), url);
	...
	private static SOAPMessage createSOAPRequest(String villageId) throws Exception {
		...
		QName bodyName = new QName("http://45.114.143.88/AreaSownServiceDetails/serviceDetails.php", "getAreaSownWeekWise",
				"m");
